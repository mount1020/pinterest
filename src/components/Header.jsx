  ...
  return (
    <header style={styles.header}>
      ...
      <nav style={styles.nav}>
        ...
        <button onClick={() => handleCategoriaClick('anime')}>Anime</button>
        <button onClick={() => handleCategoriaClick('futebol')}>futebol</button>
        <button onClick={() => handleCategoriaClick('memes')}>memes</button>
      </nav>
    </header>
  );
}
